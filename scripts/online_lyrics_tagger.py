...
# ══════════════════════════════════════════════════════════════════════════════
# Resolve the script's own directory so the logs folder can be created
# relative to it, regardless of the current working directory; behaviour is
# identical to every other script in this set.
...
#  source dir concept is now temporary_output/, set up below
# ══════════════════════════════════════════════════════════════════════════════
...
# Stage 4 of the pipeline: read/write temporary_output/ — every file gets a
# lyrics attempt here regardless of its genre status from stages 2-3.
...
def move_to_failed(filepath: str, error_type: str) -> None:
    ...
    later stages (local lyrics re-check, spotify) can still process it.
    """
